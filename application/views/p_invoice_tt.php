		...
		<div class="row">
			<div class="col-sm-6">
				...
				<div>
						...
						<li>
							<i class="ace-icon fa fa-caret-right blue"></i>SiElec
						</li>

						<li>
							<i class="ace-icon fa fa-caret-right blue"></i>Sistem Informasi
						</li>

						<li>
							<i class="ace-icon fa fa-caret-right blue"></i>Aplikasi Penjualan Electronik 
						</li>
