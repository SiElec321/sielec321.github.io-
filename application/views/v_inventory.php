...
<!--TAMBAH BARANG-->
	...
	<h4>Tambah Barang Baru</h4>
		<table id="dynatable" class="table table-striped table-bordered table-hover">
			...
			<tr>  
          	<td></td>  
            <td><div id="col_nama" class="form-control" contenteditable="true" style="height: 55px;"></div></td>  
            ...
            <td><div id="col_harga_b" class="form-control" contenteditable="true" style="height: 55px;"></div></td>  
            <td><div id="col_harga_j" class="form-control" contenteditable="true" style="height: 55px;"></div></td>
            <td><div id="col_stok" class="form-control" contenteditable="true" style="height: 55px;"></div></td>  
